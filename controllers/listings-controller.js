  ...
  const getFacebook = (async (req, res) => {
    ...
    const items = await page.evaluate(() => {
        ...
        listings.forEach((listing) => {
          ...
          // const priceElement = listing.querySelector('span.x193iq5w.xeuugli.x13faqbe.x1vvkbs.x10flsy6.x1lliihq.x1s928wv.xhkezso.x1gmr53x.x1cpjm7i.x1fgarty.x1943h6x.x1tu3fi.x3x7a5m.x1lkfr7t.x1lbecb7.x1s688f.xzsf02u');
          // const priceElement = listing.querySelector('a > div > div > div > div > span > div > span[dir="auto"]');
          // const priceElement = document.querySelector('div.x1q0g3np span[dir="auto"]');
          // const priceElement = listing.querySelector('span[dir="auto"]:contains("$")');
          ...
          //  || span.textContent.includes("Gratis"));
